...
LOCK TABLES `booking_agents` WRITE;
/*!40000 ALTER TABLE `booking_agents` DISABLE KEYS */;
INSERT INTO `booking_agents` VALUES (1,'Dele'),(2,'Sunday'),(3,'mohammed');
/*!40000 ALTER TABLE `booking_agents` ENABLE KEYS */;
UNLOCK TABLES;
