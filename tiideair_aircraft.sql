...
CREATE TABLE `aircraft` (
  `aircraft_code` int NOT NULL AUTO_INCREMENT,
  `aircraft_model` varchar(45) DEFAULT NULL,
  `aircraft_producer` varchar(45) DEFAULT NULL,
...
INSERT INTO `aircraft` VALUES (1,'Boeing 363','Boeing',150),(2,'Airbus 344','Airbus',250),(3,'Jetmi','Innoson',320);
